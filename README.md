...
it - start of shift, floor walk, incident coordination, returning from leave, and team check-in - in [`demo.js`](AgentChatWidget/demo.js). Replace them with your own.
